...
def nodeConfig():
    ...
    deltaMotorNode = network.add_node(127,'/Users/mac/tmp/HW_PY/ASDA-A3_v04.eds')
...
def deltaMotorTest():
    network = canopen.Network()
    network.connect(bustype='slcan', channel='/dev/tty.usbmodem143201', bitrate=250000)
    ...
    deltaMotorNode.sdo[0x6081].write(500000)
